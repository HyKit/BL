...
@interface WZBViewController ()

@end

@implementation WZBViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    
    UIView *v1 = [[UIView alloc] initWithFrame:(CGRect){1, 50 + 64, WZBWidth - 2, 80}];
    ...
    UIView *v2 = [[UIView alloc] initWithFrame:(CGRect){10, 160 + 64, WZBWidth - 20, 170}];
    [self.view addSubview:v2];
    // 在v2上画一个5列4行的表格，colorInfo：第2个、第6个、第11个、第16个显示红色文字，backgroundColorInfo：第0个、第5个、第12个背景颜色为黄色
    [v2 wzb_drawListWithRect:v2.bounds line:5 columns:4 datas:@[@"三等奖入选名单（黄色为队长）", @"一队", @"李小华", @"欧阳大大", @"李丽", @"史泰龙", @"二队", @"孙志鹏", @"李来德", @"希特勒", @"二狗子", @"三队", @"杰森·史坦森", @"阿莫西林", @"米其林", @"土豆", @"四队", @"乔丹", @"Angly", @"斯瓦辛格", @"狗带🐶"] colorInfo:@{@"1" : [UIColor redColor], @"6" : [UIColor redColor], @"11" : [UIColor redColor], @"16" : [UIColor redColor]} lineInfo:@{@"0" : @"1"} backgroundColorInfo:@{@"5" : [UIColor yellowColor], @"9" : [UIColor yellowColor], @"12" : [UIColor yellowColor]}];
    // 拿到v2上第一个label设置属性
    ...
    UIView *v3 = [[UIView alloc] initWithFrame:(CGRect){1, 370 + 64, WZBWidth - 2, 150}];
    [self.view addSubview:v3];
    // 在v2上画一个5列4行的表格，lineInfo：第0行只显示1列
    [v3 wzb_drawListWithRect:v3.bounds line:3 columns:5 datas:@[@"12月份各地区销售额（万）", @"广东地区", @"4685.36", @"查看详情", @"河南地区", @"6894.09", @"查看详情", @"东北地区", @"10452.78", @"查看详情", @"上海地区", @"12882.78", @"查看详情"] lineInfo:@{@"0" : @"1"}];
    // 拿到后边三个label，添加单击手势
